...
<div class="main-content">
	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <div class="page-content">
            ...
            <h1>
                    <a href="?unit=event_unit&act=input">
                                    ...
                                    while($ddatagrid=mysqli_fetch_assoc($rdatagrid)) {
                                        ...
                                        <tr>
                                             ...
                                             <td style=text-align:center>
                                                 <a href=?unit=event_unit&act=update&kd_event=$ddatagrid[kd_event] class='btn btn-sm btn-warning glyphicon glyphicon-pencil' ></a> 
                                                 <a href=?unit=event_unit&act=delete&kd_event=$ddatagrid[kd_event] class='btn btn-sm btn-danger glyphicon glyphicon-trash' onclick='return confirm(\"Yakin Akan Menghapus Data?\")'></a>    
                                             </td>                
                                        </tr>
                                        ";
                                        $no++;
			...
			<div class="main-content">
              ...
              <li>Event</li>
                ...
                $newID = $char.sprintf("%03s",$no_urut);
                    ?>          
                  <form class="form-horizontal" id="tambah_kat" nama="tambah_kat" method="post" action="?unit=event_unit&act=inputact" enctype="multipart/form-data" >    
                      ...
                      <div class="clearfix form-actions">
                        ...
                        <button type="button" name="kembali" class="btn btn-info" onclick="window.location='adminmainapp.php?unit=event_unit&act=datagrid'">kembali</button>
                         </div>
			</div> 
...
<?php
        ...
        if ($cek > 0) {
          echo "<script> alert('Data nip Sudah Ada');
              document.location='adminmainapp.php?unit=event_unit&act=input';
              </script>";
          } else {
          mysqli_query($mysqli,$qinput);
          echo "<script> alert('Data Tersimpan');
              document.location='adminmainapp.php?unit=event_unit&act=datagrid';
              </script>";
          exit();
         }
        break;
			...
			<div class="main-content">
              ...
              <li>Event</li>
					...
					<div class="page-content">
                      ...
                      <form class="form-horizontal"method="post" action="adminmainapp.php?unit=event_unit&act=updateact" enctype="multipart/form-data" >    
...
.addValidation("nama_kat","simbol","Hanya Huruf Saja");
 ...
 <?php
        ...
        ";
        $rupdate = mysqli_query($mysqli,$qupdate);
        header("location:?unit=event_unit&act=datagrid");
                 break;
