...
?>
			...
			<div class="main-content">
              ...
              <li>Pengaturan </li>
							<li>Edit Pengaturan </li>
						</ul><!-- /.breadcrumb -->
					</div>

					<div class="page-content">
						<div class="page-header"><h1>Edit Pengaturan </h1></div>
						<div class="row">
							<div class="col-xs-12">
...
<form method="post" action="?unit=user_unit&act=updateact" class="form-horizontal" enctype="multipart/form-data" >
                     ...
                     <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5"type="text" name="nip" id="nip" value="<?php echo  $dupdate['nip'] ?>" required />
                       <input class="col-xs-10 col-sm-5"type="hidden" name="kd_pelatih" id="kd_pelatih" value="<?php echo  $dupdate['kd_pelatih'] ?>" required />
                       </div>
                       </div>
                     ...
                     <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5"type="text" name="nm_pelatih" id="nm_pelatih" value="<?php echo  $dupdate['nm_pelatih'] ?>" required />
                       </div>
                       </div>
