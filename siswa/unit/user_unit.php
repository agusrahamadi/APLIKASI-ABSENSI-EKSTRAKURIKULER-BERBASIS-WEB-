...
<form method="post" action="?unit=user_unit&act=updateact" class="form-horizontal" enctype="multipart/form-data" >
                     ...
                     <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5"type="text" name="nis" id="nis" value="<?php echo  $dupdate['nis'] ?>" required />
                       <input class="col-xs-10 col-sm-5"type="hidden" name="kd_siswa" id="kd_siswa" value="<?php echo  $dupdate['kd_siswa'] ?>" required />
                       </div>
                       </div>
                     ...
                     <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5"type="text" name="nm_siswa" id="nm_siswa" value="<?php echo  $dupdate['nm_siswa'] ?>" required />
                       </div>
                       </div>
