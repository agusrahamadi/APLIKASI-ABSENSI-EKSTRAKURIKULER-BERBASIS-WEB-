...
<page>
		...
		<hr>
		<h5 align="center">DATA JADWAL </h5>
    ...
    <td style="text-align: center">pelatih 3</td>
    <td style="text-align: center">pelatih 4</td>
			</tr>
			</thead>
		 <?php
		 $no=1;
...
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['tgl']; ?>&nbsp;</td>
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['jam']; ?>&nbsp;</td>
